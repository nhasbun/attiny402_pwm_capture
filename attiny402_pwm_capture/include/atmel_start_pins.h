...
/**
 * \brief Set pwm_signal pull mode
 *
 ...
 */
static inline void pwm_signal_set_pull_mode(const enum port_pull_mode pull_mode)
{
	PORTA_set_pin_pull_mode(1, pull_mode);
}

/**
 * \brief Set pwm_signal data direction
 *
 ...
 *                      (low power state)
 */
static inline void pwm_signal_set_dir(const enum port_dir dir)
{
	PORTA_set_pin_dir(1, dir);
}

/**
 * \brief Set pwm_signal input/sense configuration
 *
 * Enable/disable pwm_signal digital input buffer and pin change interrupt,
 ...
 */
static inline void pwm_signal_set_isc(const PORT_ISC_t isc)
{
	PORTA_pin_set_isc(1, isc);
}

/**
 * \brief Set pwm_signal inverted mode
 *
 * Enable or disable inverted I/O on a pin
 *
 * \param[in] inverted true  = I/O on pwm_signal is inverted
 *                     false = I/O on pwm_signal is not inverted
 */
static inline void pwm_signal_set_inverted(const bool inverted)
{
	PORTA_pin_set_inverted(1, inverted);
}

/**
 * \brief Set pwm_signal level
 *
 ...
 */
static inline void pwm_signal_set_level(const bool level)
{
	PORTA_set_pin_level(1, level);
}

/**
 * \brief Toggle output level on pwm_signal
 *
 * Toggle the pin level
 */
static inline void pwm_signal_toggle_level()
{
	PORTA_toggle_pin_level(1);
}

/**
 * \brief Get level on pwm_signal
 *
 * Reads the level on a pin
 */
static inline bool pwm_signal_get_level()
{
